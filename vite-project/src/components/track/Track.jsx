            ...
            <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
              ...
              >
                ...
                <p className="leading-relaxed">
                  Lavish furnishes that are reliable.
                </p>
              </div>
            </div>
            <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
              ...
              >
                ...
                <p className="leading-relaxed">Get your furnishes delivered in 5-7 days.</p>
              </div>
            </div>
            <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
              <div
              ...
              >
                ...
                <p className="leading-relaxed">Amazing offers & discounts</p>
              </div>
            </div>
          </div>
        </div>
